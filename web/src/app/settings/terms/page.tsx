            ...
            <main className="max-w-2xl mx-auto p-6">
                ...
                <div className="space-y-8 text-zinc-400 text-[15px] leading-relaxed">
                    <section>
                        ...
                        <p>These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and Integra Markets ("Company", "we", "us", or "our"), concerning your access to and use of the Integra Markets mobile application as well as any other form of media, media channel, mobile website, or mobile application related, linked, or otherwise connected thereto (collectively, the "Site"). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Service.</p>
                    </section>

                    <section>
                        <h2 className="text-white font-semibold text-lg mb-3">2. Intellectual Property Rights</h2>
                    ...
                    <section>
                        <h2 className="text-white font-semibold text-lg mb-3">3. User Representations</h2>
                        <p>By using the Site, you represent and warrant that: (1) you have the legal capacity and you agree to comply with these Terms of Service; (2) you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use the Site; (3) you will not access the Site through automated or non-human means, whether through a bot, script, or otherwise; (4) you will not use the Site for any illegal or unauthorized purpose; and (5) your use of the Site will not violate any applicable law or regulation.</p>
                    </section>

                    <section>
                        <h2 className="text-white font-semibold text-lg mb-3">4. Financial Information Disclaimer</h2>
                        <p className="mb-3">Integra Markets provides AI-powered financial analysis and market insights for informational purposes only. This information does not constitute financial advice, investment recommendations, or trading signals. You acknowledge that:</p>
                    ...
                    <section>
                        <h2 className="text-white font-semibold text-lg mb-3">5. API Key Management (BYOK)</h2>
                        <p className="mb-3">Our Bring Your Own Key (BYOK) model requires you to:</p>
                        <ul className="list-disc list-inside space-y-1 ml-2">
                    ...
                    <section>
                        <h2 className="text-white font-semibold text-lg mb-3">6. Prohibited Uses</h2>
                    ...
                    <section>
                        <h2 className="text-white font-semibold text-lg mb-3">7. User Generated Content</h2>
                        <p>You may post, upload, or contribute content to the service. By doing so, you grant us a license to use, reproduce, adapt, modify, publish, or distribute such content. You represent that you own or have the necessary rights to such content and that use of your content does not infringe any third-party rights.</p>
                    </section>

                    <section>
                        <h2 className="text-white font-semibold text-lg mb-3">8. Privacy Policy</h2>
                    ...
                    <section>
                        <h2 className="text-white font-semibold text-lg mb-3">10. Disclaimer</h2>
                        <p>The information on this site is provided on an "as is" basis. To the fullest extent permitted by law, this Company excludes all representations, warranties, conditions and terms related to our service.</p>
                    </section>
                    ...
                    <section>
                        <h2 className="text-white font-semibold text-lg mb-3">13. Contact Information</h2>
                        <p>Questions about the Terms of Service should be sent to us at legal@integra-markets.com</p>
                    </section>
                </div>
