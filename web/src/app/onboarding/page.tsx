...
import { ArrowLeft, ArrowRight, Check, TrendingUp, BarChart3, Building2, Briefcase, Fuel, Droplets, Factory, Truck, Gem, Wheat, MoreHorizontal, Bell, Globe, DollarSign } from 'lucide-react';
...
export default function OnboardingPage() {
    ...
    const totalSteps = 8; // Added 3 more steps for alert preferences
    ...
    const checkAuthAndOnboarding = async () => {
        ...
        // Check if already onboarded (username is required during onboarding)
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Save alert preferences if any were selected
            if (selectedCommodities.length > 0 || selectedRegions.length > 0 || selectedCurrencies.length > 0) {
    ...
    const canProceed = () => {
        switch (currentStep) {
            ...
            case 8: return formData.username.trim() !== ''; // Confirmation
            default: return true;
        }
    };
    ...
    const isOptionalStep = () => {
        return currentStep === 1 || currentStep === 2 || currentStep === 5 || currentStep === 6 || currentStep === 7;
    };
            ...
            <main className="flex-1 overflow-y-auto">
                <div className="max-w-2xl mx-auto px-6 py-8">
                    ...
                    {currentStep === 5 && (
                        <div className="animate-fadeIn">
                            <div className="flex items-center gap-3 mb-2">
                                <Bell size={24} className="text-[#4ECCA3]" />
                                <h1 className="text-2xl font-semibold text-white">Alert Preferences</h1>
                            </div>
                            <h2 className="text-xl text-white mb-2">Select Commodities (Optional)</h2>
                    ...
                    {currentStep === 6 && (
                        <div className="animate-fadeIn">
                            <div className="flex items-center gap-3 mb-2">
                                <Globe size={24} className="text-[#4ECCA3]" />
                                <h1 className="text-2xl font-semibold text-white">Select Regions (Optional)</h1>
                            </div>
                    ...
                    {currentStep === 7 && (
                        <div className="animate-fadeIn">
                            <div className="flex items-center gap-3 mb-2">
                                <DollarSign size={24} className="text-[#4ECCA3]" />
                                <h1 className="text-2xl font-semibold text-white">Select Currencies (Optional)</h1>
                            </div>
